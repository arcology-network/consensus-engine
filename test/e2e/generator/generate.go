...
var (
	...
	// FIXME: grpc disabled due to https://github.com/arcology-network/consensus-engine/issues/5439
	...
	nodeMisbehaviors = weightedChoice{
		...
		// https://github.com/arcology-network/consensus-engine/issues/5617
